...
export const routes = [
    ...
    <Route path="reservations/edit/:resv_id/:username" element={<EditReservation />} />,
    <Route path="reservations/privacy" element={<ResvPrivacy />} />,
    <Route path="reservations/privacy/edit/:privacy" element={<EditPrivacy />} />,
    <Route path="reservations/status" element={<ResvStatus />} />,
    <Route path="reservations/status/edit/:status" element={<EditStatus />} />,
    
    <Route path="users" element={<Users />} />,
    <Route path="users/edit/:username" element={<EditUser />} />,
    <Route path="users/add" element={<AddUser />} />,
    <Route path="users/roles" element={<UserRoles />} />,
    <Route path="users/roles/edit/:role" element={<EditUserRole />} />,

    <Route path="rooms" element={<Rooms />} />,
    <Route path="rooms/add" element={<AddRoom />} />,
    <Route path="rooms/edit/:room_id" element={<EditRoom />} />,
    <Route path="rooms/status" element={<RoomStatus />} />,
    <Route path="rooms/status/edit/:status" element={<EditRoomStatus />} />,
    <Route path="rooms/types" element={<RoomTypes />} />,
    <Route path="rooms/types/add" element={<AddRoomType />} />,
    <Route path="rooms/types/edit/:type" element={<EditRoomType />} />,

    <Route path="sessions" element={<Sessions />} />,
    <Route path="sessions/add" element={<AddSession />} />,
    <Route path="sessions/edit/:session_id" element={<EditSession />} />,

    <Route path="notices" element={<Notices />} />,
    <Route path="notices/add" element={<AddNotice />} />,
    <Route path="notices/edit/:notice_id/:username" element={<EditNotice />} />,
